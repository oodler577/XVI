...
view {
  ; X16: 80-column / 60-row Commander X16 editor geometry.
...
main {
  ...
  sub splash() {
    ...
    say("~                    writting using the Prog8 Programming Language ")
    say("~                                                                  ")
  ...
  sub key_mode_nav() {
    when char {
      ...
      ; X16 raw CBM cursor and control-key aliases.
...
txt {
  %option merge
  ; X16 VERA text matrix fast scroll implementation.
